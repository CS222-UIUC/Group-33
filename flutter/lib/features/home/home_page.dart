      ...
      children: [
        ListView(
          ...
          children: [
            ...
            if (_connected) _buildPlayerStateWidget() else const Center(
            ...
            if (_connected) _buildPlayerContextWidget() else const Center(
              child: Text('Not connected'),
            ),
            const Divider(),
            const Text(
          ...
          children: <Widget>[
            Row(
              ...
              children: <Widget>[
                ...
                if (playerState.isPaused) SizedIconButton(
                  width: 50,
                  icon: Icons.play_arrow,
                  onPressed: resume,
                ) else SizedIconButton(
                  width: 50,
                  icon: Icons.pause,
                  onPressed: pause,
                ),
            ...
            if (_connected) spotifyImageWidget(track.imageUri) else const Text('Connect to see an image...'),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Divider(),
